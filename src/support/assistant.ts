...
export const DEFAULT_SUPPORT_ASSISTANT_SETTINGS: SupportAssistantSettings = {
  ...
  welcomeMessage: "Hola, soy el asistente de mycellios. Puedo explicar el proyecto, revisar el estado real de la red y ayudarte con instalación, drivers, modelos o potencia del dispositivo.",
  suggestions: [
    "No entiendo cómo funciona mycellios",
    "Tengo un problema con los drivers de mi GPU",
    "¿Qué modelos están disponibles ahora?",
  ],
  maxOutputTokens: 512,
  temperature: 0.2,
