...
message = re.sub(r"nodecodex-org/", "", message, flags=re.I)
message = re.sub(r"(?im)^Co-authored-by:.*(?:jarvis|claude|nodecodex).*(?:\n|$)", "", message)
...
message = re.sub(r"(?i)Nodecodex", "project host", message)
