...
describe("release uploads", () => {
  ...
  it("restricts OIDC claims to this repository, workflow and release refs", () => {
    expect(validateGitHubReleaseClaims({
      repository: "example/mycellios",
      ref: "refs/heads/main",
      sha: "a".repeat(40),
      workflow_ref: "example/mycellios/.github/workflows/node-build.yml@refs/heads/main",
      event_name: "push",
    ...
    expect(validateGitHubReleaseClaims({
      ...
      sha: "b".repeat(40),
      workflow_ref:
        "example/mycellios/.github/workflows/publish-existing-release.yml@refs/heads/main",
    ...
    expect(() => validateGitHubReleaseClaims({
      ...
      sha: "b".repeat(40),
      workflow_ref:
        "example/mycellios/.github/workflows/node-build.yml@refs/heads/main-evil",
      event_name: "push",
      environment: "production",
...
function releaseClaims(sha: string): GitHubReleaseClaims {
  return {
    ...
    sha,
    workflowRef:
      "example/mycellios/.github/workflows/node-build.yml@refs/heads/main",
    eventName: "push",
    environment: "production",
  };
}
