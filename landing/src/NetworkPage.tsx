    ...
    <section className="net-data" id="network-evidence" aria-labelledby="net-data-title">
      <div className="net-data-shell">
        ...
        <section className="net-method" aria-labelledby="net-method-title">
          ...
          <div className="net-method-links"><a href="/docs">Read the protocol <ExternalLink /></a><a href="https://github.com/example/mycellios" target="_blank" rel="noreferrer">Inspect the source <ExternalLink /></a></div>
        </section>
      </div>
    </section>
  </main>;
